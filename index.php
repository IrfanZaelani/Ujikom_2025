                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <form action="controllers/c_login.php?aksi=login" method="POST" class="user">
                                ...
                                <div class="form-group">
                                    <input type="password" class="form-control form-control-user" id="exampleInputEmail" placeholder="Password" name="pass">
                                </div>
